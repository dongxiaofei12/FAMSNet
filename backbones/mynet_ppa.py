...
from mmseg.models.utils import build_norm_layer, GRN, PPA
...
class ConvNeXtBlock(BaseModule):
    ...
    def __init__(self,
        ...
        # 集成 PPA 模块
        self.ppa = PPA(in_features=in_channels, filters=in_channels)
...
class MyNetPPA(BaseModule):
    ...
    def train(self, mode=True):
        super(MyNetPPA, self).train(mode)
        self._freeze_stages()
