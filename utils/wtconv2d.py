...
class DepthwiseSeparableConvWithWTConv2d(nn.Module):
    def __init__(self,in_channels, out_channels, kernel_size=3, wt_levels=1, wt_type='db1'):
        ...
        self.depthwise = WTConv2d(in_channels, in_channels, kernel_size=kernel_size, wt_levels=wt_levels, wt_type=wt_type)
...
if __name__ == '__main__':
    input_data = torch.randn(1, 768, 16, 16)

    wtconv = DepthwiseSeparableConvWithWTConv2d(kernel_size=3,in_channels=768, out_channels=768)
